 ...
 */
public class TimeRateLimiter<T> implements Observable.Operator<T, T> {
    private final long time;
    private final TimeUnit unit;
    private final Scheduler scheduler;

    public TimeRateLimiter(long time, TimeUnit unit, Scheduler scheduler) {
        this.time = time;
        this.unit = unit;
        this.scheduler = scheduler;
    }

    public TimeRateLimiter(long time, TimeUnit unit) {
